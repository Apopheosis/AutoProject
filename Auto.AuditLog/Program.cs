...
namespace Auto.AuditLog
{
    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            Console.WriteLine("Hello, start listening something hehehe.");
        ...
        {
            var csv =
                $"{message.ModelCode},{message.Registration},{message.Manufacturer},{message.ModelName},{message.Color},{message.Year},{message.ListedAtUtc:O}";
